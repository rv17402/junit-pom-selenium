...
public class MultiPageTest {
	...
	public void testMultiPage() {
		...
		try {
			p2.takeScreenShot("C://java-workspace//TestSelinium//src//test//java//com//junit//test//result//Multipage2.png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			p3.takeScreenShot("C://java-workspace//TestSelinium//src//test//java//com//junit//test//result//Multipage3.png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		p4.agree();
		try {
			p4.takeScreenShot("C://java-workspace//TestSelinium//src//test//java//com//junit//test//result//Multipage4.png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			p4.takeScreenShot("C://java-workspace//TestSelinium//src//test//java//com//junit//test//result//MultipageAfterSubmit.png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void pizzaiPage() {
		...
		try {
			pizza.takeScreenShot("C://java-workspace//TestSelinium//src//test//java//com//junit//test//result//pizzaBeforeOrder.png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		Assert.assertEquals("Click OK to return to the Main Dashboard", element.getText());
		try {
			pizza.takeScreenShot("C://java-workspace//TestSelinium//src//test//java//com//junit//test//result//pizzaAfterOrder.png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
